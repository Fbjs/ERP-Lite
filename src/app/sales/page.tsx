...
export const initialOrders: Order[] = [
    // Previous Orders with updated dispatchers
    { id: 'SALE881', customerId: '2', locationId: 'loc2', customer: 'Cafe Central', amount: 270000, status: 'Completado', date: '2025-08-27', deliveryDate: '2025-08-28', deliveryAddress: 'Av. Providencia 1234, Providencia', items: [{ recipeId: 'TIPA0500', formatSku: 'TIPA0500-40K', quantity: 75, lote: 'LOTE2508A' }], dispatcher: 'Felipe Campos', comments: 'Entregar por acceso de servicio.' },
    { id: 'SALE882', customerId: '3', locationId: 'loc3', customer: 'Supermercado del Sur', amount: 820000, status: 'Pendiente', date: '2025-08-28', deliveryDate: '2025-08-30', deliveryAddress: 'Gran Avenida 5678, La Cisterna', items: [{ recipeId: 'CRUT11MM', formatSku: 'CRUT11MM-U10', quantity: 200 }], dispatcher: 'Diego Cid', comments: '' },
    { id: 'SALE883', customerId: '1', locationId: 'loc1', customer: 'Panaderia San Jose', amount: 330000, status: 'Enviado', date: '2025-08-28', deliveryDate: '2025-08-29', deliveryAddress: 'Calle Larga 45, Maipú', items: [{ recipeId: 'GUABCO16', formatSku: 'GUABCO16-9.5', quantity: 80 }], dispatcher: 'Gabriel Martinez', comments: 'Horario de entrega estricto: 8am-10am' },
    { id: 'SALE884', customerId: '2', locationId: 'loc2', customer: 'Cafe Central', amount: 150000, status: 'Cancelado', date: '2025-08-29', deliveryDate: '2025-08-30', deliveryAddress: 'Av. Providencia 1234, Providencia', items: [{ recipeId: '400100', formatSku: '400100-7', quantity: 71 }], dispatcher: 'Felipe Campos', comments: 'Cliente cancela por sobrestock.' },
    
    // New orders for planning from Sept 1st with updated dispatchers
    { id: 'SALE885', customerId: '3', locationId: 'loc4', customer: 'Supermercado del Sur', amount: 550000, status: 'En Preparación', date: '2025-08-30', deliveryDate: '2025-09-01', deliveryAddress: 'Bodega Central, Av. Departamental 987, San Miguel', items: [{ recipeId: 'GUAINT16', formatSku: 'GUAINT16-7', quantity: 120, lote: 'LOTE2508B' }], dispatcher: 'Diego Cid', comments: 'Preparar en cajas especiales.' },
    { id: 'SALE886', customerId: '1', locationId: 'loc1', customer: 'Panaderia San Jose', amount: 184000, status: 'Pendiente', date: '2025-08-31', deliveryDate: '2025-09-02', deliveryAddress: 'Calle Larga 45, Maipú', items: [{ recipeId: 'RALLADBCO', formatSku: 'RALLADBCO-10K', quantity: 40 }], dispatcher: 'Francisca Sandoval', comments: '' },
    { id: 'SALE887', customerId: '2', locationId: 'loc2', customer: 'Cafe Central', amount: 440000, status: 'Completado', date: '2025-08-31', deliveryDate: '2025-09-01', deliveryAddress: 'Av. Providencia 1234, Providencia', items: [{ recipeId: 'GUIN1432', formatSku: 'GUIN1432-1K', quantity: 100 }], dispatcher: 'Alejandro Zuñiga', comments: 'Facturar a RUT diferente.' },
    { id: 'SALE888', customerId: '3', locationId: 'loc3', customer: 'Supermercado del Sur', amount: 615000, status: 'Completado', date: '2025-09-01', deliveryDate: '2025-09-02', deliveryAddress: 'Gran Avenida 5678, La Cisterna', items: [{ recipeId: 'GUBL1332', formatSku: 'GUBL1332-11', quantity: 150 }], dispatcher: 'Esteban Troncoso', comments: '' },
    { id: 'SALE889', customerId: '1', locationId: 'loc1', customer: 'Panaderia San Jose', amount: 205000, status: 'Completado', date: '2025-09-02', deliveryDate: '2025-09-03', deliveryAddress: 'Calle Larga 45, Maipú', items: [{ recipeId: 'GUABCO16', formatSku: 'GUABCO16-9.5', quantity: 50 }], dispatcher: 'Felipe Campos', comments: '' },
    { id: 'SALE890', customerId: '3', locationId: 'loc3', customer: 'Supermercado del Sur', amount: 984000, status: 'Completado', date: '2025-09-02', deliveryDate: '2025-09-03', deliveryAddress: 'Gran Avenida 5678, La Cisterna', items: [{ recipeId: 'CRUT11MM', formatSku: 'CRUT11MM-U10', quantity: 240 }], dispatcher: 'Rene Medel', comments: 'Necesita 2 guías de despacho.' },
    { id: 'SALE891', customerId: '2', locationId: 'loc2', customer: 'Cafe Central', amount: 52500, status: 'Pendiente', date: '2025-09-03', deliveryDate: '2025-09-03', deliveryAddress: 'Av. Providencia 1234, Providencia', items: [{ recipeId: '400100', formatSku: '400100-7', quantity: 25 }], dispatcher: 'Diego Cid', comments: '' },
    { id: 'SALE892', customerId: '1', locationId: 'loc1', customer: 'Panaderia San Jose', amount: 430000, status: 'Completado', date: '2025-09-03', deliveryDate: '2025-09-02', deliveryAddress: 'Calle Larga 45, Maipú', items: [{ recipeId: 'GUAINT16', formatSku: 'GUAINT16-7', quantity: 100 }], dispatcher: 'Gabriel Martinez', comments: 'Cliente pide llamar antes de entregar.' },
    { id: 'SALE893', customerId: '3', locationId: 'loc4', customer: 'Supermercado del Sur', amount: 1230000, status: 'Pendiente', date: '2025-09-04', deliveryDate: '2025-09-01', deliveryAddress: 'Bodega Central, Av. Departamental 987, San Miguel', items: [{ recipeId: 'MIGAARG22', formatSku: 'MIGAARG22-11', quantity: 341 }], dispatcher: 'Rene Medel', comments: '' },
    { id: 'SALE894', customerId: '2', locationId: 'loc2', customer: 'Cafe Central', amount: 82000, status: 'Enviado', date: '2025-09-04', deliveryDate: '2025-09-02', deliveryAddress: 'Av. Providencia 1234, Providencia', items: [{ recipeId: 'GUABCO16', formatSku: 'GUABCO16-9.5', quantity: 20 }], dispatcher: 'Alejandro Zuñiga', comments: '' },
    { id: 'SALE895', customerId: '1', locationId: 'loc1', customer: 'Panaderia San Jose', amount: 360000, status: 'Completado', date: '2025-09-05', deliveryDate: '2025-09-03', deliveryAddress: 'Calle Larga 45, Maipú', items: [{ recipeId: 'TIPA0500', formatSku: 'TIPA0500-40K', quantity: 100, lote: 'LOTE2509A' }], dispatcher: 'Esteban Troncoso', comments: '' },
];
