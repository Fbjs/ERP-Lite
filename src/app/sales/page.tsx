...
export const initialOrders: Order[] = [
    ...
    { id: 'SALE889', customerId: '1', locationId: 'loc1', customer: 'Panaderia San Jose', amount: 205000, status: 'Pendiente', date: '2025-09-02', deliveryDate: '2025-09-04', deliveryAddress: 'Calle Larga 45, Maipú', items: [{ recipeId: 'GUABCO16', formatSku: 'GUABCO16-9.5', quantity: 50 }], dispatcher: 'RENE', comments: '' },
    { id: 'SALE890', customerId: '3', locationId: 'loc3', customer: 'Supermercado del Sur', amount: 984000, status: 'En Preparación', date: '2025-09-02', deliveryDate: '2025-09-05', deliveryAddress: 'Gran Avenida 5678, La Cisterna', items: [{ recipeId: 'CRUT11MM', formatSku: 'CRUT11MM-U10', quantity: 240 }], dispatcher: 'MARCELO', comments: 'Necesita 2 guías de despacho.' },
    { id: 'SALE891', customerId: '2', locationId: 'loc2', customer: 'Cafe Central', amount: 52500, status: 'Pendiente', date: '2025-09-03', deliveryDate: '2025-09-04', deliveryAddress: 'Av. Providencia 1234, Providencia', items: [{ recipeId: '400100', formatSku: '400100-7', quantity: 25 }], dispatcher: 'RENE', comments: '' },
    { id: 'SALE892', customerId: '1', locationId: 'loc1', customer: 'Panaderia San Jose', amount: 430000, status: 'En Preparación', date: '2025-09-03', deliveryDate: '2025-09-05', deliveryAddress: 'Calle Larga 45, Maipú', items: [{ recipeId: 'GUAINT16', formatSku: 'GUAINT16-7', quantity: 100 }], dispatcher: 'MARCELO', comments: 'Cliente pide llamar antes de entregar.' },
    { id: 'SALE893', customerId: '3', locationId: 'loc4', customer: 'Supermercado del Sur', amount: 1230000, status: 'Pendiente', date: '2025-09-04', deliveryDate: '2025-09-06', deliveryAddress: 'Bodega Central, Av. Departamental 987, San Miguel', items: [{ recipeId: 'MIGAARG22', formatSku: 'MIGAARG22-11', quantity: 341 }], dispatcher: 'RENE', comments: '' },
    { id: 'SALE894', customerId: '2', locationId: 'loc2', customer: 'Cafe Central', amount: 82000, status: 'Enviado', date: '2025-09-04', deliveryDate: '2025-09-05', deliveryAddress: 'Av. Providencia 1234, Providencia', items: [{ recipeId: 'GUABCO16', formatSku: 'GUABCO16-9.5', quantity: 20 }], dispatcher: 'MARCELO', comments: '' },
    { id: 'SALE895', customerId: '1', locationId: 'loc1', customer: 'Panaderia San Jose', amount: 360000, status: 'Completado', date: '2025-09-05', deliveryDate: '2025-09-06', deliveryAddress: 'Calle Larga 45, Maipú', items: [{ recipeId: 'TIPA0500', formatSku: 'TIPA0500-40K', quantity: 100 }], dispatcher: 'RENE', comments: '' },
];
