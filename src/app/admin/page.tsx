...
import { Building2, Contact, Landmark, ShieldCheck, ShoppingBag, Trash2, Users, BadgePercent, Group } from 'lucide-react';
...
const adminSections = [
    ...
    { href: '/admin/product-families', title: 'Familias de Productos', description: 'Organiza las categorías de recetas.', icon: Group },
